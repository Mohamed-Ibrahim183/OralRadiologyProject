...
const NavAdmin = () => {
  ...
  const [theme, setTheme] = useState(() => {
    let tmp = localStorage.getItem("theme") || Object.keys(themeMap)[0];
    localStorage.setItem("theme", tmp);
    return tmp;
  });

  useEffect(() => {
    document.body.classList.add("AdminBody", theme);
    return () => document.body.classList.remove("AdminBody", theme);
  }, [theme]);
      ...
      <ul className="navbar-nav">
        <li className="logo">
          <a href="#" className="nav-link">
            <span className="link-text logo-text">Fire ship</span>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
        ...
        <li className="nav-item" id="themeButton" onclick={toggleTheme}>
          <a href="#" className="nav-link">
            ...
            <span className="link-text">Change Theme</span>
          </a>
        </li>
      </ul>
    </nav>
